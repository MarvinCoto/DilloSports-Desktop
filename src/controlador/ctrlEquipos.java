 ...
 * @author marvi
 */
public class ctrlEquipos implements MouseListener, KeyListener{
    ...
    public void keyReleased(KeyEvent e) {
        ...
        if (e.getSource() == vistaEquipos.txtBuscar) {
            modeloEquipos.Buscar(vistaEquipos.jtbEquipos, vistaEquipos.txtBuscar);
        }
