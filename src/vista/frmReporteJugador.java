 ...
 * @author marvi
 */
public class frmReporteJugador extends javax.swing.JFrame {
    ...
    public static void initFrmReportesAdmin(){
        ...
        frmReporteJugador vista = new frmReporteJugador();
        ctrlReportesJugador controlador = new ctrlReportesJugador(vista);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmReporteJugador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
