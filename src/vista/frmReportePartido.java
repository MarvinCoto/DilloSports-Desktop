 ...
 * @author marvi
 */
public class frmReportePartido extends javax.swing.JFrame {

    /**
     * Creates new form frmReporteArbitro
     */
    public frmReportePartido() {
        initComponents();
    ...
    public static void initFrmReportesAdmin(){
        ...
        frmReportePartido vista = new frmReportePartido();
        ctrlReportesPartido controlador = new ctrlReportesPartido(vista);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmReportePartido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
