 ...
 * @author marvi
 */
public class frmReporteEquipo extends javax.swing.JFrame {

    /**
     * Creates new form frmReporteArbitro
     */
    public frmReporteEquipo() {
        initComponents();
    }
    ...
    public static void initFrmReportesAdmin(){
        ...
        frmReporteEquipo vista = new frmReporteEquipo();
        ctrlReportesEquipo controlador = new ctrlReportesEquipo(vista);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmReporteEquipo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
