 ...
 * @author marvi
 */
public class frmReporteArbitro extends javax.swing.JFrame {
    ...
    public static void initFrmReportesAdmin(){
        ...
        frmReporteArbitro vistaArbitro = new frmReporteArbitro();
        ctrlReportesArbitro controlador = new ctrlReportesArbitro(vistaArbitro);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmReporteArbitro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
